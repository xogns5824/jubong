...
<style>
#span { font-size:50px; margin-left:30%;}
#agreement {
...
function chk() { 
	if (form.checkbox.checked == true) {
		return true
	}else { alert("약관동의를 체크하여야 합니다.");
	return false
	;}
}
</script> 
<body>
<form action="join_form.jsp" name="form" method="post">
 <table width="500" height="650" align="center" border="0">

  <tr>
   <td width="100%" height="50%" colspan="2">
   <p>
   <span  id="span" >회 원 약 관</span>
   </p>
   <br>
   <textarea
     rows="20" cols="80" >가. 수집하는 개인정보의 항목첫째, 회사는 회원가 입, 원활한 고객상담, 각종 서비스의 제공을 위해 최초 회원가입 당시 아래와 같은 최소한의 개인정보를 필수항목으로 수집하고 있습니다.
회원가입
...
<tr>
  <td>약관에 동의하십니까?</td>
  <td align="right"><input type="checkbox" name="checkbox" ></td> 
  </tr>
  <tr >
   <td align="center" valign="top" colspan="2">
    <input type="button" value="비동의" onclick="location.replace('../index.jsp');" id="agreement"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="동의" onclick="return chk()" id="agreement" name="el"/>
   </td>
  </tr>
 </table>
</form>
